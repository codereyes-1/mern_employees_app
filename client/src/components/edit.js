...
//   This will get the record based on the id from the database.
  componentDidMount() {
    axios
      .get("https://mern-employees.herokuapp.com:3000/record/" + this.props.match.params.id)
      .then((response) => {
        this.setState({
...
//  componentDidMount() {
//    fetch("https://mern-employees.herokuapp.com:3000/record/" + this.props.match.params.id)
//      .then((response) => {
//        this.setState({
//          person_name: response.data.person_name,
//          person_position: response.data.person_position,
...
//  }
  ...
  onSubmit(e) {
    ...
    axios
      .post(
        "https://mern-employees.herokuapp.com:3000/update/" + this.props.match.params.id,
        newEditedperson
      )
